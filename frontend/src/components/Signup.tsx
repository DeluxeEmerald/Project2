...
function Signup() {
    ...
    function validatePassword() {
        ...
        if (firstName.length < 2) {
            nextErrors.push('Please enter a valid first name');
        }

        if (lastName.length < 2) {
            nextErrors.push('Please enter a valid last name');
        }

        if (!emailRegex.test(email)) {
            nextErrors.push('Please enter a valid email.');
        }
    ...
    async function submitSignUp() {
        ...
        if (validPassword) {
            ...
            const obj = { name: loginName, password: password, email: email };
        ...
        <section className='auth-layout'>
            ...
            <div id='loginDiv' className='auth-card stack-lg'>
                ...
                <div className='auth-form'>
                    ...
                    <input type='submit' id='loginButton' className='primary-button' value='Create Account' onClick={() => submitSignUp()} />
                    <p className='text-black'>Already have an account? <button onClick={toLogin} className='inline-button'>Back to Login</button></p>
